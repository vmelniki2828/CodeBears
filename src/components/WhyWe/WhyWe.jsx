...
import { WhyWeContainer, WhyWeMainTitle, WhyWeSubTitle,WhyWeList,WhyWeItem ,WhyWeItemTitle,WhyWeItemSubTitle} from "./WhyWe.styled";
...
const WhyWe = () => {
    ...
    return (<WhyWeContainer id="WhyWe" ref={whyWeRef}>
        ...
        <WhyWeList className="why-bottom">
            <WhyWeItem><WhyWeItemTitle>Legal Processing.</WhyWeItemTitle><WhyWeItemSubTitle>We love creativity, but do not forget about the objective reality, all our business deals are designed in such a way that each party gets the desired result.</WhyWeItemSubTitle></WhyWeItem>
            <WhyWeItem><WhyWeItemTitle>Legal Processing.</WhyWeItemTitle><WhyWeItemSubTitle>We love creativity, but do not forget about the objective reality, all our business deals are designed in such a way that each party gets the desired result.</WhyWeItemSubTitle></WhyWeItem>
            <WhyWeItem><WhyWeItemTitle>Legal Processing.</WhyWeItemTitle><WhyWeItemSubTitle>We love creativity, but do not forget about the objective reality, all our business deals are designed in such a way that each party gets the desired result.</WhyWeItemSubTitle></WhyWeItem>
        </WhyWeList>
    </WhyWeContainer>)
